...
var Slider = function Slider(props, ref) {
  ...
  return /*#__PURE__*/_react["default"].createElement("div", {
    ...
    var range = max - min;
    var percentFromCenter = (range / 2 - (max - label.value)) / (range || 1) * 100;

    if (percentFromCenter > 50 || percentFromCenter < -50) {
      console.warn("".concat(type.name, ": Label ").concat(label.title, " has a value outside of the slider range: ").concat(label.value));
      return null;
    }
